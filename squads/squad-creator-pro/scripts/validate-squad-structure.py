#!/usr/bin/env python3
"""Compatibility proxy for the canonical squad-creator structure validator."""
...
def _load_base_module():
    if not BASE_SCRIPT.exists():
        raise FileNotFoundError(f"Canonical base script not found: {BASE_SCRIPT}")
    ...
    spec = importlib.util.spec_from_file_location(
        "squad_creator_base_validate_squad_structure",
        BASE_SCRIPT,
    )
