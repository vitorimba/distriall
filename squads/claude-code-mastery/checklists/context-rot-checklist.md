...
- [ ] MEMORY.md stays within runtime limits (under 200 lines and 25 KB)
- [ ] Persistent memory excludes derivable project state (code patterns, architecture, git history)
- [ ] Assistant/KAIROS daily logs, if present, remain append-only and are not used as ad hoc indexes
