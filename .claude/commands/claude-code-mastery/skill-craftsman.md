    ...
    claude_code_skills:
      skill_md_format:
        ...
        frontmatter_fields:
          ...
          - name: arguments
            required: false
            description: "Named arguments for substitution and autocomplete. Accepts string or string[]. Enables semantic placeholders beyond positional $ARGUMENTS."
          - name: when_to_use
            required: false
            description: "Extra routing hint shown to the model. Start with 'Use when...' and describe trigger conditions, not implementation detail."
          - name: version
            required: false
            description: "Version string for the skill contract. Useful for maintenance, packaging, and generated documentation."
          ...
          - name: context
            required: false
            description: "Claude runtime only treats 'fork' specially. Omitted or any other value behaves as inline/default. Local ecosystems may define extra labels, but they are not native routing semantics."
          - name: agent
            required: false
          ...
          - name: effort
            required: false
            description: "Per-turn reasoning override for the skill. Accepts named effort levels or an integer when supported by the runtime."
          - name: shell
            required: false
            description: "Shell used for inline !-block preprocessing inside the markdown body. Valid values: bash, powershell. Invalid values degrade to bash."
          - name: paths
            required: false
            description: "Conditional activation globs. Skills with paths are not always available; they move into the dynamic pool only after matching file paths are touched."
          - name: hooks
            required: false
        ...
        sinkra_extension_fields:
          - name: owner_squad
            description: "Local governance metadata. Useful for ownership and compliance, but not interpreted by Claude Code runtime."
          - name: sinkra_tier
            description: "Local governance tier. Validation and reporting field, not native skill-routing metadata."
          - name: license
            description: "Packaging and governance metadata. Ignored by Claude Code runtime."
